  ...
  return (
    <div className="font-body-md antialiased selection:bg-custom-btn-primary selection:text-white bg-[#070708] text-[#e5e2e3] min-h-screen flex flex-col justify-between">
      ...
      <header className="bg-[#070708]/90 backdrop-blur-md w-full top-0 h-[80px] border-b border-white/[0.05] z-50 fixed">
        <div className="flex justify-between items-center w-full px-8 max-w-[1728px] mx-auto h-full">
      ...
      {/* Main Content */}
      <main className="flex-grow w-full max-w-[1516px] mx-auto mt-[80px] px-8 py-16">
        {children}
      </main>

      {/* Footer */}
      <footer className="bg-[#0a0a0b] border-t border-white/[0.05] flex flex-col justify-between px-8 pt-24 pb-16 w-full">
        <div className="max-w-[1728px] w-full mx-auto grid grid-cols-2 md:grid-cols-6 gap-16 mb-16">
